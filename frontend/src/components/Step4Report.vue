    ...
    <div class="main-split-layout">
      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="workflow-overview" v-if="agentLogs.length > 0 || reportOutline">
          ...
          <button v-if="isComplete" class="next-step-btn" @click="goToReview">
            <span>{{ $t('step4.goToReview') }}</span>
...
const goToReview = () => {
  if (props.reportId) {
    router.push({ name: 'Review', params: { reportId: props.reportId } })
  }
}
...
const renderMarkdown = (content) => {
  ...
  // 处理证据引用编号 [ev_xxx] → 带样式的 badge
  html = html.replace(/\[(ev_\d{3})\]/g, '<span class="ev-ref">$1</span>')
...
.generated-content :deep(.md-h2) { font-size: 22px; border-bottom: 2px solid #111827; padding-bottom: 10px; margin-top: 2em; }
.generated-content :deep(.md-h3) { font-size: 18px; border-left: 3px solid #3B82F6; padding-left: 12px; }
.generated-content :deep(.md-h4) { font-size: 16px; }

.generated-content :deep(.ev-ref) {
